...
#		self.parser.add_argument('--train_dataset', type=str, default=r'../../derain1/dataset/train/R100H', help='path to training dataset')
#		self.parser.add_argument('--eval_dataset', type=str, default=r'../../derain1/dataset/train/R100H', help='path to evaluation dataset')
		self.parser.add_argument('--train_dataset', type=str, default=r'../dataset/Rain200H/train1', help='path to training dataset')
		self.parser.add_argument('--eval_dataset', type=str, default=r'../dataset/Rain100L/test1', help='path to evaluation dataset')

		self.parser.add_argument('--test_dataset', type=str, default='./dataset/test_b', help='path to test dataset')
		self.parser.add_argument('--result', type=str, default=r'./train_result/Rain200H-FTCA1', help='path to save dataset')
		self.parser.add_argument('--lr', type=float, default=0.001, help='learning rate')
		self.parser.add_argument('--iter', type=int, default=100,help='number of iterations')
