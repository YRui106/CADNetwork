...
class TrainOptions():
	...
	def initialize(self):
		...
		self.parser.add_argument('--train_dataset', type=str, default='./dataset/100H/Rain100H_all', help='path to training dataset')
		self.parser.add_argument('--eval_dataset', type=str, default='./dataset/100H/rain100H_test', help='path to evaluation dataset')
		self.parser.add_argument('--test_dataset', type=str, default='./dataset/test_b', help='path to test dataset')
		self.parser.add_argument('--result', type=str, default=r'./result/Rain100H_all', help='path to save dataset')
		self.parser.add_argument('--lr', type=float, default=0.0000001, help='learning rate')
		self.parser.add_argument('--iter', type=int, default=1000, help='number of iterations')
